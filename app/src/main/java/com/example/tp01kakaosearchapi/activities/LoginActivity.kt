...
import com.example.tp01kakaosearchapi.G
import com.example.tp01kakaosearchapi.databinding.ActivityLoginBinding
import com.example.tp01kakaosearchapi.model.NidUserInfoResponse
import com.example.tp01kakaosearchapi.model.UserAccount
    ...
    private fun clickedLoginNaver(){
        ...
        NaverIdLoginSDK.authenticate(this, object : OAuthLoginCallback{
            ...
            override fun onSuccess() {
                ...
                // 사용자를 정보를 가져오려면 서버와 HTTP REST API 통신을 해야함.
                // 단, 필요한 요청파라미터가 있음. 사용자정보에 접속할 수 있는 인증키 같은 값 - 토큰 이라고 부름
                val accessToken:String? = NaverIdLoginSDK.getAccessToken()

                //토큰값을 확인해보기 - 토큰값을 그때그때 마다 갱신됨. [즉, 1회용 접속 키]
