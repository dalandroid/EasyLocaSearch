package com.example.tp01kakaosearchapi.activities
...
import com.example.tp01kakaosearchapi.R
import com.example.tp01kakaosearchapi.databinding.ActivityMainBinding
import com.example.tp01kakaosearchapi.fragments.SearchListFragment
import com.example.tp01kakaosearchapi.fragments.SearchMapFragment
import com.example.tp01kakaosearchapi.model.KakaoSearchPlaceResponse
import com.example.tp01kakaosearchapi.model.Place
import com.example.tp01kakaosearchapi.model.PlaceMeta
import com.example.tp01kakaosearchapi.network.RetrofitApiService
import com.example.tp01kakaosearchapi.network.RetrofitHelper
...
class MainActivity : AppCompatActivity() {
    ...
    private fun clickChoice(view: View){
        ...
        when( view.id ){
            ...
            R.id.choice_01-> searchQuery="마트"
            R.id.choice_02-> searchQuery="마트"
            R.id.choice_03-> searchQuery="마트"
            R.id.choice_04-> searchQuery="마트"
            R.id.choice_05-> searchQuery="마트"
        }
